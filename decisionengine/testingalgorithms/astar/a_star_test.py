...
# Class that tests the graphs for astar algorithm
class AStarTest(unittest.TestCase):
    ...
    def test_basic_linear_path_graph(self):
        self.assertEquals(astar(self.g3, 'a', 'b'), (3, ['a', 'c', 'b']))
    ...
    def test_small_square_cyclical_graph(self):
        distance, path = astar(self.g4, 'a', 'b')
    ...
    def test_small_cycle_inside_of_graph(self):
        ...
        distance, path = astar(self.g5, 'a', 'b')
    ...
    def test_random_node_disconnected_graphs(self):
        self.assertEquals(astar(self.g7, 'a', 'b'), (3, ['a', 'c', 'b']))
    ...
    def test_large_mostly_linear_graph_to_check_multiple_paths(self):
        self.assertEquals(astar(self.g8, 'a', 'b'), (1, ['b']))
